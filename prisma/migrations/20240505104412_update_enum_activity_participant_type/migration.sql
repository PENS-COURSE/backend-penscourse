/*
  ...
  - The values [leave] on the enum `ActivityParticipantType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ActivityParticipantType_new" AS ENUM ('join', 'disconnect', 'end');
